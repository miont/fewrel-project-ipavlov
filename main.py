...
sentence_encoder = EntityAwareAttentionRnn(word_embedder, max_length, hidden_size=100, pos_embedding_dim=50, n_heads=4, attention_dim=50, num_latent_types=3, cuda=cuda)
